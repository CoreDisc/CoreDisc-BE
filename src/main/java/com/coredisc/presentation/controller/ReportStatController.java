...
import com.coredisc.application.service.report.ReportStatQueryServiceImpl;
...
public class ReportStatController implements ReportStatControllerDocs {
    ...
    public ApiResponse<ReportResponseDTO.QuestionListDTO> getMonthlyQuestionList(int year, int month, @CurrentMember Member member) {
    ...
    public ApiResponse<ReportResponseDTO.MostSelectedQuestionDTO> getMostSelectedQuestions(LocalDate startDate, LocalDate endDate, @CurrentMember Member member) {
    ...
    public ApiResponse<ReportResponseDTO.PeakHourDTO> getPeakHour(LocalDate startDate, LocalDate endDate, @CurrentMember Member member) {
    ...
    public ApiResponse<ReportResponseDTO.TopDailySelectionDTO> getMostSelectedDaily(int year, int month, @CurrentMember Member member) {
    ...
    public ApiResponse<ReportResponseDTO.DailyDetailListDTO> getDailyDetail(int year, int month, @CurrentMember Member member) {
