...
public interface FollowControllerDocs {
    ...
    @Operation(summary = "타사용자의 팔로워 목록 조회", description = "타사용자의 팔로워 목록 조회 기능입니다. 커서 기반 페이징입니다.")
    @Parameters({
            @Parameter(name = "cursorId", description = "마지막으로 조회한 followId입니다. 첫 요청 때는 null, queryString입니다."),
            @Parameter(name = "size", description = "기본값 10")
    })
    ...
    @Operation(summary = "타사용자의 팔로잉 목록 조회", description = "타사용자의 팔로잉 목록 조회 기능입니다. 커서 기반 페이징입니다.")
    @Parameters({
            @Parameter(name = "cursorId", description = "마지막으로 조회한 followId입니다. 첫 요청 때는 null, queryString입니다."),
            @Parameter(name = "size", description = "기본값 10")
    })
